...
excerpt: "Developed an automated robotic arm prototype integrating a custom-designed PCB, ARM M051 embedded C firmware, and a Raspberry Pi-based object classification model for vision-guided manipulation tasks.<br/><img src='/images/500x300.png'>"
